...
export default function CountryDetails(props) {
    let getCountry = id => props.location.state.countriesState.find(obj => obj.cca3 === id) //Location és la URL
    const { cca3 } = props.match.params //match treu paràmetres de la URL
